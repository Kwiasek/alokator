...
# Znacznik czasowy: 2024-10-26 12:13:36.703116
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wno-error=implicit-fallthrough -std=c11 -pedantic -Werror -Wextra -Wno-error=parentheses -DINSIDE_DANTE -Wno-parentheses -D_ANSI_OUTPUT -Werror=vla -D_GNU_SOURCE -Wall -fmax-errors=5 -xc -fdiagnostics-color -ggdb3 -Wno-error=unused-parameter 
